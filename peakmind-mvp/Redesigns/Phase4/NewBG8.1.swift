...
struct RoutineBuilderView1: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            .padding(.bottom, 50)
            .background(
                NavigationLink(destination: RoutineBuilderView2(selectedActivity: selectedOptions.first ?? ""), isActive: $navigateToNextView) {
                    EmptyView()
                }
            )
        }
...
// Preview
struct RoutineBuilderView1_Previews: PreviewProvider {
