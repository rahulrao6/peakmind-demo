...
struct P3CandEView: View {
    ...
    let introText = """
    Crack the code of your anxiety! By learning the why behind those physical symptoms, you'll be equipped to handle stress head-on the moment it strikes.
    
    First, let’s write out the cause or trigger of three physical symptoms of anxiety that you experience.
    
    Then, write out the results of the causes you wrote. What happens physically when these triggers happen?
    """
        ...
        GeometryReader { geometry in
            ZStack {
                ...
                VStack(spacing: 36) {
                    ...
                    .background(
                        NavigationLink(
                            destination: P3IntroView2(), // replace with your next screen view
...
struct P3CandEView_Previews: PreviewProvider {
