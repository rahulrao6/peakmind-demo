...
struct P3MentalHealthFeatureView2: View {
...
struct P3FeatureBulletPoint2: View {
    var text: String
...
struct P3MentalHealthFeatureView2_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            P3MentalHealthFeatureView2()
        }
    }
}
