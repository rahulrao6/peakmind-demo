...
struct P2MentalHealthFeatureView: View {
...
struct P2FeatureBulletPoint: View {
    var text: String
...
struct P2MentalHealthFeatureView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            P2MentalHealthFeatureView()
        }
    }
}
