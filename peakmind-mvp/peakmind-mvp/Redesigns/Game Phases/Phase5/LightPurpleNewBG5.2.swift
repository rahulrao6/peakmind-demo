...
struct P5Negative2: View {
    ...
    init(firstText: String, secondText: String, thirdText: String, supportNames: [String]) {
...
struct P5Negative2_Previews: PreviewProvider {
    static var previews: some View {
        P5Negative2(
            firstText: "Challenge 1",
            secondText: "Challenge 2",
            thirdText: "Challenge 3",
            supportNames: ["First Support", "Second Support", "Third Support", "Fourth Support"]
        )
    }
}
