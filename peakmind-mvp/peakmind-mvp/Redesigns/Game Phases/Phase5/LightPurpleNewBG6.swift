...
struct P5MentalHealthFeatureView2: View {
...
struct P5FeatureBulletPoint2: View {
    var text: String
...
struct P5MentalHealthFeatureView2_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            P5MentalHealthFeatureView2()
        }
    }
}
