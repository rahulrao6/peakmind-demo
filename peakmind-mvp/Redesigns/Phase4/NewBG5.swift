...
struct WellnessQuestionView2: View {
        ...
        GeometryReader { geometry in
            ZStack {
                ...
                VStack(spacing: 8) {
                    ...
                    // question text
                    Text("What coping strategies have you found most helpful when dealing with high-stress situations?")
...
struct WellnessQuestionView2_Previews: PreviewProvider {
    static var previews: some View {
        WellnessQuestionView2()
    }
}
