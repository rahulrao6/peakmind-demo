            ...
            ZStack {
                ...
                VStack(spacing: 16) {
                    ...
                    if correctAnswers.contains(selectedOption ?? "") {
                        ...
                        NavigationLink(destination: WellnessQuestionView3(), isActive: $navigateToNextView) {
                            EmptyView()
                        }
                    }
                }
...
struct AnswerBox5: View {
    ...
    var body: some View {
        Button(action: {
            ...
            HStack {
                Text(text)
                    .font(.custom("SFProText-Medium", size: 16)) // Slightly reduced font size
                    .foregroundColor(Color("TextInsideBoxColor"))
                    .padding(.vertical, 8)
                    .padding(.horizontal, 12)
...
struct P4QuizPageView_Previews: PreviewProvider {
