...
// Component for animating each bullet point of the intro text
struct FeatureBulletPoint3: View {
    var text: String
...
struct P3BodyScan_Previews: PreviewProvider {
