...
struct RoutineBuilderView2: View {
    ...
    var body: some View {
        ...
        return VStack(spacing: 20) {
            ...
            .padding(.bottom, 50)
            .background(
                NavigationLink(destination: RoutineBuilderView3(selectedActivity1: selectedActivity, selectedActivity2: selectedOptions.first ?? ""), isActive: $navigateToNextView) {
                    EmptyView()
                }
            )
        }
...
// Preview
struct RoutineBuilderView2_Previews: PreviewProvider {
    static var previews: some View {
        RoutineBuilderView2(selectedActivity: "Stretching")
    }
}
