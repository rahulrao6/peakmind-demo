...
struct P2StressFeatureView: View {
        ...
        GeometryReader { geometry in
            ZStack {
                ...
                VStack(spacing: 16) {
                    ...
                    NavigationLink(destination: P2QuizIntro(), isActive: $navigateToWellnessQuestion) {
                        EmptyView()
                    }
                }
                .padding(.horizontal)
...
struct P2StressBulletPoint: View {
    var text: String
...
struct P2StressFeatureView_Previews: PreviewProvider {
