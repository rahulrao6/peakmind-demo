...
struct ConnectingStressors: View {
    ...
    let texts = ["Let’s take a look at some specific\n external stressors in your life. We’ll\n identify some coping mechanisms to\n respond, helping us to reduce anxiety\n as soon as it presents itself.", "What are 3 external factors\n in your life that cause you\n anxiety?"]
...
struct ConnectingStressors_Previews: PreviewProvider {
