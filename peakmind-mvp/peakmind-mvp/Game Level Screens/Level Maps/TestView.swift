                ...
                SpriteView(scene: scene)
                    ...
                    .onAppear {
                        scene.levels = [
                            ...
                            LevelNode(uid: 0, internalName: "P1_MentalHealthMod", title: "Physical Impacts", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 3),
                            LevelNode(uid: 1, internalName: "P1_MentalHealthMod", title: "Body Scan", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 3),
                            LevelNode(uid: 2, internalName: "P1_MentalHealthMod", title: "Anxiety Physical", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 3),
                            LevelNode(uid: 3, internalName: "P1_MentalHealthMod", title: "Anxiety Emotional", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 3),
                            LevelNode(uid: 4, internalName: "P1_MentalHealthMod", title: "Wellness Question", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 3),
                            LevelNode(uid: 5, internalName: "P1_MentalHealthMod", title: "Scenario", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 3),
                            LevelNode(uid: 6, internalName: "P1_MentalHealthMod", title: "Managing Anxiety", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 3),
                            LevelNode(uid: 7, internalName: "P1_MentalHealthMod", title: "Self Care", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 3),
                            LevelNode(uid: 8, internalName: "P1_MentalHealthMod", title: "Emotions Checklist", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 3),
                            LevelNode(uid: 9, internalName: "P1_MentalHealthMod", title: "Minigame", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 3),
