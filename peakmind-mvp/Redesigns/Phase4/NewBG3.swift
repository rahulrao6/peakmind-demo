...
struct P4MentalHealthFeatureView: View {
...
struct P4FeatureBulletPoint: View {
    var text: String
...
struct P4MentalHealthFeatureView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            P4MentalHealthFeatureView()
        }
    }
}
