                ...
                SpriteView(scene: scene)
                    ...
                    .onAppear {
                        scene.levels = [
                            ...
                            LevelNode(uid: 0, internalName: "P4_1", title: "Resilience Checklist", viewFactory: { AnyView(P4_1_1(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 4),
                            LevelNode(uid: 1, internalName: "P4_2", title: "Resilience", viewFactory: { AnyView(P4_2_1(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 4),
                            LevelNode(uid: 2, internalName: "P4_3", title: "5/4/3/2/1 Coping", viewFactory: { AnyView(P4_3_1(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 4),
                            LevelNode(uid: 3, internalName: "P4_4", title: "Wellness Question", viewFactory: { AnyView(P4_4_1(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 4),
                            LevelNode(uid: 4, internalName: "P4_5", title: "Sherpa Chat", viewFactory: { AnyView(P4_5_1(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 4),
                            LevelNode(uid: 5, internalName: "P4_6", title: "Routine", viewFactory: { AnyView(P4_6_1(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 4),
                            ...
                            LevelNode(uid: 7, internalName: "P4_8", title: "Scenario", viewFactory: { AnyView(P4_8_1(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 4),
                            LevelNode(uid: 8, internalName: "P4_9", title: "Wellness Question", viewFactory: { AnyView(P4_9_1(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 4),
                            LevelNode(uid: 9, internalName: "P4_10", title: "Minigame", viewFactory: { AnyView(P1_MentalHealthMod(closeAction: { Task {try await viewModel.markLevelCompleted(levelID: activeModal!.internalName); scene.currentLevel = -1} })) }, phase: 4),
